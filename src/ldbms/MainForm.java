	...
	private void initialize() {
	    ...
	    //frame.setSize(dim.width,dim.height);
	     ...
	     mnAccountSettings.add(mntmChangeUsernamdpassword);
	      ...
	      mntmCreateNewUser.setVisible(false);
	     ...
	     mntmDeleteUser.setVisible(false);
...
String returndate=null;
	     ...
	     btnLogout.setIcon(new ImageIcon(MainForm.class.getResource("/ldbms/9.png")));
	    ...
	    // btnLogout.setIcon(new ImageIcon("D:\\ldbms\\images\\7.png"));
	     ...
	     lblNewLabel.setIcon(new ImageIcon(MainForm.class.getResource("/ldbms/5.jpg")));
